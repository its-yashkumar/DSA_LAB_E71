...
long sec, ms; 
// arrays to check for // best -> increasing array // average -> random array // worst -> decreasing array 
...
{
     if (l < r) { int m = l + (r - l) / 2; mergeSortRec(arr, l, m);
 ...
 int main()
  { 
    ...
    printf("----------------|-------------------------------------------------\n"); { 
        ...
        ms = ((sec * 1000000) + end.tv_usec) - (start.tv_usec); printf("%.2lu.%.6lu\t", sec, ms);
         // Worst case 
         gettimeofday(&start, NULL); 
         // start time 
         bubbleSort(MAXNUM, decArr); gettimeofday(&end, NULL); 
         // end time 
         sec = (end.tv_sec - start.tv_sec); 
         ms = ((sec * 1000000) + end.tv_usec) - (start.tv_usec);
          ...
          // end time 
          sec = (end.tv_sec - start.tv_sec); 
          ms = ((sec * 1000000) + end.tv_usec) - (start.tv_usec); printf("%.2lu.%.6lu\n", sec, ms); 
          } { // Insertion sort 
        ...
        sec = (end.tv_sec - start.tv_sec);
         ms = ((sec * 1000000) + end.tv_usec) - (start.tv_usec);
        printf("%.2lu.%.6lu\t", sec, ms); // average case 
        gettimeofday(&start, NULL); 
        // start time 
    ...
    { 
        ...
        gettimeofday(&end, NULL); 
        // end time 
        sec = (end.tv_sec - start.tv_sec); ms = ((sec * 1000000) + end.tv_usec) - (start.tv_usec); 
        printf("%.2lu.%.6lu\t", sec, ms); 
        // average case 
        gettimeofday(&start, NULL); 
        // start time 
